...
public class Anwendung {
	...
	public static void main(String[] args) {
		...
		System.out.println("Bitte geben Sie die gewuenschte Kantenlaenge der Fliese ein: ");
		...
		for (int i = 0; i < abschnitt.length; i++) {
			System.out.println("Bitte geben Sie die Laenge des " + (i+1) + ". Abschnitts ein: ");
			int laenge = scanner.nextInt();
			System.out.println("Bitte geben Sie die Breite des " + (i+1) + ". Abschnitts ein: ");
		...
		System.out.println("Insgesamt werden " + bodenFlaeche.anzahlFliesen(fliese) + " Fliesen ben�tigt");
