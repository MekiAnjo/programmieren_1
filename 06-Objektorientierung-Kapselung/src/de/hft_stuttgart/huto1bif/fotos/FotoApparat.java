...
public class FotoApparat {
	...
	FotoApparat(String marke, int megaPixel, double displayGroesse, boolean bildStabilisiert, Objektiv objektiv) {
		super();
		this.marke = marke;
	...
	void machFoto() {
		if (objektiv == null) {
			...
			System.out.println("Klick mit (" + objektiv.getBrennweiteMin() + "," + objektiv.getBrennweiteMax() + ")");
		}
	}
	...
	public String toString() {
		...
		stringBuilder.append("FotoApparat [marke=").append(marke).append(", megaPixel=").append(megaPixel)
				.append(", displayGroesse=").append(displayGroesse).append(", bildStabilisiert=")
				.append(bildStabilisiert).append(", objektiv=").append(objektiv).append("]");
