public class BarbecueDinner {
  ...
  public static void main(String[] args) {
    ...
    double totalCalories =
      (
        flourAmount *
        flourCaloriesPerGram +
        potatoAmount *
        potatoCaloriesPerGram +
        frozenPizzaAmount *
        pizzaCaloriesPerServing +
        bbqSpitAmount *
        bbqSpitCaloriesPerServing +
        potatoSaladAmount *
        potatoSaladCaloriesPerGram +
        minceAmount *
        minceCaloriesPerGram
      );
    ...
    System.out.println("-----------------------");
    System.out.println(
      "Mehl            = " + flourAmount * flourCaloriesPerGram + " kcal"
    );
    System.out.println(
      "Kartoffeln      = " + potatoAmount * potatoCaloriesPerGram + " kcal"
    );
    System.out.println(
      "Tiefkühlpizza   = " +
      frozenPizzaAmount *
    ...
    System.out.println(
      "Grillspieße     = " + bbqSpitAmount * bbqSpitCaloriesPerServing + " kcal"
    );
    System.out.println(
      "Kartoffelsalat  = " +
      potatoSaladAmount *
    ...
    System.out.println(
      "Hackfleisch     = " + minceAmount * minceCaloriesPerGram + " kcal\n"
    );
    System.out.println(
      "Summe der Kalorien aller Produkte = " + totalCalories + " kcal"
    );
    System.out.println("-----------------------");
    ...
    System.out.printf(
      "%-15s = %.2f kcal %n",
      "Mehl",
      flourAmount * flourCaloriesPerGram
    );
    System.out.printf(
      "%-15s = %.2f kcal %n",
      "Kartoffeln",
      potatoAmount * potatoCaloriesPerGram
    );
    System.out.printf(
      "%-15s = %.2f kcal %n",
      "Tiefkühlpizza",
      frozenPizzaAmount * pizzaCaloriesPerServing
    );
    System.out.printf(
      "%-15s = %.2f kcal %n",
      "Grillspieße",
      bbqSpitAmount * bbqSpitCaloriesPerServing
    );
    System.out.printf(
      "%-15s = %.2f kcal %n",
      "Kartoffelsalat",
      potatoSaladAmount * potatoSaladCaloriesPerGram
    );
    System.out.printf(
      "%-15s = %.2f kcal %n%n",
      "Hackfleisch",
      minceAmount * minceCaloriesPerGram
    );
    System.out.printf(
      "Summe der Kalorien aller Produkte = %.2f kcal %n",
      totalCalories
    );
    System.out.printf("-----------------------");
  }
